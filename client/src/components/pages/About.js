  ...
  return (
    <>
      <Container text style={{ marginTop: "7em" }}>
        ...
        <p>
          The Open Source curates easy pickings from popular open-source
          projects, and helps you make your first contribution to open-source.
        </p>
        <Card.Group itemsPerRow={3} stackable>
          <Card>
            <Image
              src={process.env.PUBLIC_URL + "/img/jack.jpg"}
              alt="Jack"
              wrapped
              ui={false}
            />
          ...
          <Card>
            <Image
              src={process.env.PUBLIC_URL + "/img/shiham.jpg"}
              alt="Jack"
              wrapped
              ui={false}
            />
          ...
          <Card>
            <Image
              src={process.env.PUBLIC_URL + "/img/dale.jpg"}
              alt="Jack"
              wrapped
              ui={false}
            />
